...
class Training_model extends CI_Model {
    ...
    public function read_data($start,$length,$search,$no_md,$status_proses){
        ...
        $read_data = $this->client->request('POST','TrainingMd/', ['verify' => false,
            'form_params' => [
                                'no_md' => $no_md,
                                'search' => $search,
                                'length' => $length,
    ...
    public function save_staff($no_md,$admin_hcmg){
        $save_staff = $this->client->request('POST','TrainingMd/', ['verify' => false,
        'form_params' => [
                            'no_md' => $no_md,
    ...
    public function peserta_train($no_md){
        $get_peserta_train = $this->client->request('POST','peserta/', ['verify' => false,
        'form_params' => [
                            'no_md' => $no_md,
                            'api_auth_key' => 'f99aecef3d12e02dcbb6260bbdd35189c89e6e73'
                            // 'status' => 'ADMIN NON MEMO'
