    ...
    class M_Datatables extends CI_Model
    {
        ...
        function get_tables_query_train($query,$cari,$where,$iswhere)
        {
            ...
            if($where != null)
            {
                ...
                if(!empty($iswhere))
                {
                    $sql = $this->db_training->query($query." WHERE  $iswhere AND ".$fwhere);
                    
                }else{
                    $sql = $this->db_training->query($query." WHERE ".$fwhere);
                }
                $sql_count = $sql->num_rows();
                ...
                if(!empty($iswhere))
                {
                    $sql_data = $this->db_training->query($query." WHERE $iswhere AND ".$fwhere." AND (".$cari.")".$order." LIMIT ".$limit." OFFSET ".$start);
                }else{
                    $sql_data = $this->db_training->query($query." WHERE ".$fwhere." AND (".$cari.")".$order." LIMIT ".$limit." OFFSET ".$start);
                }
                ...
                if(isset($search))
                {
                    if(!empty($iswhere))
                    {
                        $sql_cari =  $this->db_training->query($query." WHERE $iswhere AND ".$fwhere." AND (".$cari.")");
                    }else{
                        $sql_cari =  $this->db_training->query($query." WHERE ".$fwhere." AND (".$cari.")");
                    }
                    $sql_filter_count = $sql_cari->num_rows();
                }else{
                    if(!empty($iswhere))
                    {
                        $sql_filter = $this->db_training->query($query." WHERE $iswhere AND ".$fwhere);
                    }else{
                        $sql_filter = $this->db_training->query($query." WHERE ".$fwhere);
                    }
                    $sql_filter_count = $sql_filter->num_rows();
                }
                $data = $sql_data->result_array();
                ...
                if(!empty($iswhere))
                {
                    $sql = $this->db_training->query($query." WHERE  $iswhere ");
                }else{
                    $sql = $this->db_training->query($query);
                }
                $sql_count = $sql->num_rows();
                ...
                if(!empty($iswhere))
                {                
                    $sql_data = $this->db_training->query($query." WHERE $iswhere AND (".$cari.")".$order." LIMIT ".$limit." OFFSET ".$start);
                }else{
                    $sql_data = $this->db_training->query($query." WHERE (".$cari.")".$order." LIMIT ".$limit." OFFSET ".$start);
                }
                ...
                if(isset($search))
                {
                    if(!empty($iswhere))
                    {     
                        $sql_cari =  $this->db_training->query($query." WHERE $iswhere AND (".$cari.")");
                    }else{
                        $sql_cari =  $this->db_training->query($query." WHERE (".$cari.")");
                    }
                    $sql_filter_count = $sql_cari->num_rows();
                }else{
                    if(!empty($iswhere))
                    {
                        $sql_filter = $this->db_training->query($query." WHERE $iswhere");
                    }else{
                        $sql_filter = $this->db_training->query($query);
                    }
                    $sql_filter_count = $sql_filter->num_rows();
                }
                $data = $sql_data->result_array();
