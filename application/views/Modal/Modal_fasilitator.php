    ...
    <form  id="form_<?=$id?>">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-7 form-group">
            <input type="text" id="input-no_telepon" onkeyup="key(this)" value="<?php echo (( $kode_fasilitator)? $kode_fasilitator->no_telp : '' ) ?>" name="no_telepon" class="form-control" required <?php echo (( $id == 'modal_delete')? 'disabled' : '' ) ?> >
            <div id="error"></div>
            </div>
        </div>
        <div class="mb-3 row">
            ...
            <div class="col-sm-7 form-group">
              <select id="input-kode_vendor" name="kode_vendor"  required <?php echo (( $id == 'modal_delete')? 'disabled' : '' ) ?> class="form-select" aria-label="Default select example">
                <option  value="<?php echo (( $kode_fasilitator)? $kode_fasilitator->kode_vendor : '' ) ?>" selected>   <?php echo (( $kode_fasilitator)? $kode_fasilitator->nama_vendor : '' ) ?></option>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-7 form-group">
            <select  name="kategori" onchange="check_v(this)" id="input-kategori" class="form-select" aria-label="Default select example" required <?php echo (( $id == 'modal_delete')? 'disabled' : '' ) ?>>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-7 form-group">
            <select  name="jenis_fasilitator" onchange="check_v(this)" id="input-jenis_fasilitator" class="form-select" aria-label="Default select example" required <?php echo (( $id == 'modal_delete')? 'disabled' : '' ) ?>>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-7 form-group">
            <select  name="status" onchange="check_v(this)" id="input-status" class="form-select" aria-label="Default select example" required <?php echo (( $id == 'modal_delete')? 'disabled' : '' ) ?>>
