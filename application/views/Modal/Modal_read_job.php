  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        ...
        <section class="body-content">
            ...
            <form id="form_read">
                <?php if ($job_profile->status == '1') { ?>
                    <button type="button" class="btn btn-success btn-sm float-end" style="cursor: default;">Sudah Membaca & Setuju</button>
                <?php } else {?>
                    <input type="hidden" value="1" name="status">
                    <input type="hidden" value="<?= $job_profile_id ?>" name="id">
                    <button type="button" data="read" onclick="action_submit(this)" class="btn btn-primary btn-sm float-end">Sudah Membaca & Setuju</button>
                <?php } ?>
            </form>
            </section>
        </div>
