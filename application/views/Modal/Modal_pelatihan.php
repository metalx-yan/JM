    ...
    <form  id="form_<?= $id?>">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 row">
            ...
            <input type="hidden" id="input-kode_pelatihan" onkeyup="key(this)" value="<?php echo (( $kode_pelatihan)? $kode_pelatihan->kode_pelatihan : '' ) ?>" name="kode_pelatihan" class="form-control" required <?php echo (( $id == 'modal_edit' || $id == 'modal_delete')? 'readonly' : '' ) ?> >
            <div id="error"></div>
            </div>
        </div>
        <div class="mb-3 row">
