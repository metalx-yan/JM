                    ...
                    <div class="tab-content">
                        ...
                        <br>
                          <form id="form_<?= $tujuan ?>">
                            ...
                            <button type="button" data="<?= $tujuan ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $tujuan ?>" disabled>SAVE</button>
                        </form>
                        </div>
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12 form-group">
                                    <?php foreach($desc_tugas_tanggung_jawab_id as $data_desc_tugas_tanggung_jawab):?>
                                        <div id="inputFormRow_<?= $tugas ?>">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button id="removeRow_<?= $tugas ?>" data="<?= $tugas ?>" onclick="dels(this)" type="button" class="btn btn-danger btn-sm" disabled>Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                        ...
                                        <button id="addRow_<?= $tugas ?>" data="<?= $tugas ?>" onclick="tabs(this)" type="button" class="btn btn-primary btn-sm" disabled>Add Row</button>
                                    <span id="error"></span>
                                </div>
                            </div>

                            <button type="button" data="<?= $tugas ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $tugas ?>" disabled>SAVE</button>
                                    ...
                                    <?php foreach($kewenangan_id as $data_kewenangan):?>
                                        ...
                                        <div id="inputFormRow_<?= $kewenangan ?>">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button id="removeRow_<?= $kewenangan ?>" data="<?= $kewenangan ?>" onclick="dels(this)" type="button" class="btn btn-danger btn-sm" disabled>Remove</button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                        ...
                                        <button id="addRow_<?= $kewenangan ?>"  data="<?= $kewenangan ?>" onclick="tabs(this)" type="button" class="btn btn-primary btn-sm" disabled>Add Row</button>
                                    <span id="error"></span>
                                </div>
                            </div>

                            <button type="button" disabled data="<?= $kewenangan ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $kewenangan ?>" disabled>SAVE</button>
                        ...
                        <br>
                          ...
                          <input type="hidden" value="<?= $kualifikasi ?>" name="eksekutor">
                            ...
                            <input type="hidden" value="<?= $kualifikasi ?>" name="eksekutor">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 d-flex align-content-end flex-wrap">
                                        <button id="removeRow_<?= $kualifikasi ?>" data="<?= $kualifikasi ?>" onclick="dels(this)" type="button" class="btn btn-danger btn-sm" disabled>Remove</button>
                                    </div>
                            ...
                            <br>
                            <button id="addRow_<?= $kualifikasi ?>" data="<?= $kualifikasi ?>" onclick="tabs(this)" type="button" class="btn btn-primary btn-sm" disabled>Add Row</button>
                            <br>
                            ...
                            <?php foreach($work_experience as $work):?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="checkbox" name="description[]" value="<?=  $work['id']?>" <?= (in_array($work['id'], $data_description)) ? 'checked' : ''?>  disabled>  <?= $work['description']?>
                                    </div>
                                </div>
                            <?php endforeach; ?>

                            <br>
                            <button type="button" disabled data="<?= $kualifikasi ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $kualifikasi ?>" disabled>SAVE</button>
                          ...
                          <input type="hidden" value="<?= $kompetensi ?>" name="eksekutor">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12 form-group">
                                        ...
                                        <?php foreach($kompetensi_id as $data_kompetensi):?>
                                            <div id="inputFormRow_<?= $kompetensi ?>">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button id="removeRow_<?= $kompetensi ?>" data="<?= $kompetensi ?>" onclick="dels(this)" type="button" class="btn btn-danger btn-sm" disabled>Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                        ...
                                        <button id="addRow_<?= $kompetensi ?>" data="<?= $kompetensi ?>" onclick="tabs(this)" type="button" class="btn btn-primary btn-sm" disabled>Add Row</button>
                                    <span id="error"></span>
                                </div>
                            </div>

                            <button type="button" disabled data="<?= $kompetensi ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $kompetensi ?>" disabled>SAVE</button>
                          ...
                          <input type="hidden" value="<?= $kpi ?>" name="eksekutor">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12 form-group">
                                        ...
                                        <button id="addRow_<?= $kpi ?>" data="<?= $kpi ?>" onclick="tabs(this)" type="button" class="btn btn-primary btn-sm" disabled>Add Row</button>
                                    <span id="error"></span>
                                </div>
                            </div>

                            <button type="button" disabled data="<?= $kpi ?>" onclick="action_submit(this)" class="btn btn-warning float-end btn_save_<?= $kpi ?>" disabled>SAVE</button>
