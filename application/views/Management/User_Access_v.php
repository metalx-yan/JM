...
<script>
    ...
    function default_dt() {
            $('#manage_menu').DataTable({
                ...
                "ajax": {
                    "url": "<?= base_url('Management/User_Access_c/get/'); ?>", // URL file untuk proses select datanya
                    "type": "POST"
                },
                "deferRender": true,
                "aLengthMenu": [
    ...
    function action_submit(data_) {
        ...
        if (action == 'modal_delete') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('Management/User_Access_c/validate'); ?>",
                data: form,
                dataType: "json",
    ...
    $("#add").on('click', () => {
        var val = {};
        val.modal = 'MODAL USER ACCESS';
        val.id = 'modal_add';
        console.log(val);
        $.ajax({
            url: '<?php echo base_url('Management/User_Access_c/modal') ?>',
            type: "post",
            data: val,
    ...
    function edit_modal() {
        var val = {};
        val.modal = 'MODAL EDIT USER ACCESS';
        val.id = 'modal_edit';
        val.form_id = "form_" + val.id;
        val.id_key = event.target.value;
        console.log(val);
        $.ajax({
            url: '<?= base_url('Management/User_Access_c/modal/') ?>',
            type: "post",
            data: val,
            success: function(res) {
                // alert(res);
    ...
    function delete_modal() {
        var val = {};
        val.modal = 'MODAL DELETE USER ACCESS';
        val.id = 'modal_delete';
        val.id_key = event.target.value;
        $.ajax({
            url: '<?= base_url('Management/User_Access_c/modal/') ?>',
    ...
    function save(form) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('Management/User_Access_c/save_/') ?>',
                    type: "post",
                    data: form,
                    beforeSend: function() {
                        $("#loader").show();
    ...
    function edit(form) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('Management/User_Access_c/edit_/') ?>',
                    type: "post",
                    data: form,
                    success: function(res) {
    ...
    function delete_(form) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('Management/User_Access_c/destroy_/') ?>',
                    type: "post",
                    data: form,
                    success: function(res) {
    ...
    function key(tes) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Management/User_Access_c/validate_keyup/'); ?>",
            data: val,
            dataType: "json",
            success: function(data) {
                $.each(data, function(key, value) {
