...
class penyelenggara_c extends CI_Controller {
    public function __construct(){
        ...
        access_login();
        $this->id = 'kode_penyelenggara';
    }

    public function index(){
        $data['title_head'] = 'Penyelenggara';
        ...
        $this->load->view('Setting_parameter/penyelenggara_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM penyelenggara";
        $search = array('kode_penyelenggara', 'keterangan_penyelenggara');
        $where  = null; 
    ...
    public function modal(){
        $table = 'penyelenggara';
        $field = 'kode_penyelenggara';
        $modal = $this->input->post('modal');
        $id = $this->input->post('id');
        $kode_ = $this->input->post('kode_penyelenggara');
        $data['kode_penyelenggara'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_penyelenggara',$data,TRUE);
        echo $html_modal;
    }
