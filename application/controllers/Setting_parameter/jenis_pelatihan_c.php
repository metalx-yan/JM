...
class jenis_pelatihan_c extends CI_Controller {
    public function __construct(){
        ...
        access_login();
        $this->id = 'kode_pelatihan';
    }

    public function index(){
        $data['title_head'] = 'Jenis Pelatihan';
        ...
        $this->load->view('Setting_parameter/jenis_pelatihan_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM jenis_pelatihan";
        $search = array('kode_pelatihan', 'nama_pelatihan','sandi_LKPBU','sandi_OJK');
        $where  = null; 
    ...
    public function modal(){
        $table = 'jenis_pelatihan';
        $field = 'kode_pelatihan';
        $modal = $this->input->post('modal');
        $id = $this->input->post('id');
        $kode_ = $this->input->post('kode_pelatihan');
        $data['kode_pelatihan'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_pelatihan',$data,TRUE);
        echo $html_modal;
    }
