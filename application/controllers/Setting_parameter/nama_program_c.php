...
class nama_program_c extends CI_Controller {
    public function __construct(){
        ...
        access_login();
        $this->id = 'kode_program';
    }

    public function index(){
        $data['title_head'] = 'Nama Program';
        ...
        $this->load->view('Setting_parameter/nama_program_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM nama_program";
        $search = array('kode_program', 'nama_program','jenis_program','keterangan_program');
        $where  = null; 
    ...
    public function modal(){
        ...
        $kode_ = $this->input->post('kode_program');
        $data['kode_program'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_program',$data,TRUE);
        echo $html_modal;
    }
