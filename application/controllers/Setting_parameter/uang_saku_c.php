...
class uang_saku_c extends CI_Controller {
    ...
    public function get(){
        ...
        $search = array('kode_uang_saku', 'kode_pangkat', 'keterangan_peserta', 'dalam_luar_negri', 'tujuan_negara', 'uang_makan', 'nilai_nominal', 'mata_uang');
        $where  = null; 
