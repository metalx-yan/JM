...
class item_budget_c extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('Setting_parameter/item_budget_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM item_budget";
        $search = array('kode_budget', 'keterangan_budget','jenis_budget','nominal');
        $where  = null; 
    ...
    public function modal(){
        ...
        $kode_ = $this->input->post('kode_budget');
        $data['kode_budget'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_budget_item',$data,TRUE);
        echo $html_modal;
    }
