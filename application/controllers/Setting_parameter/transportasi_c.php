...
class transportasi_c extends CI_Controller {
    public function __construct(){
        ...
        access_login();
        $this->id = 'kode_transportasi';
    }

    public function index(){
        $data['title_head'] = 'TRANSPORTASI';
        ...
        $this->load->view('Setting_parameter/transportasi_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM transportasi";
        $search = array('kode_transportasi', 'kode_pangkat', 'kelas_transportasi', 'nilai_nominal');
        $where  = null; 
    ...
    public function modal(){
        $table = 'transportasi';
        $field = 'kode_transportasi';
        $modal = $this->input->post('modal');
        $id = $this->input->post('id');
        $kode_ = $this->input->post('kode_transportasi');
        $data['kode_transportasi'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_transportasi',$data,TRUE);
        echo $html_modal;
    }
    ...
    function validate(){
        ...
        foreach($_POST as $key => $val){
            ...
            }elseif ($key == 'kode_transportasi' || $key == 'nilai_nominal') {
                $require = '';
            }
            else{
