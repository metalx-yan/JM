...
class kelompok_training_c extends CI_Controller {
    public function __construct(){
        ...
        access_login();
        $this->id = 'kode_kelompok';
    }

    public function index(){
        $data['title_head'] = 'Kelompok Training';
        ...
        $this->load->view('Setting_parameter/kelompok_training_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM kelompok_training";
        $search = array('kode_kelompok', 'keterangan_kelompok');
        $where  = null; 
    ...
    public function modal(){
        $table = 'kelompok_training';
        $field = 'kode_kelompok';
        $modal = $this->input->post('modal');
        $id = $this->input->post('id');
        $kode_ = $this->input->post('kode_kelompok');
        $data['kode_kelompok'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_kelompok',$data,TRUE);
        echo $html_modal;
    }
