...
class unit_kerja_c extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('Setting_parameter/unit_kerja_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM unit_kerja";
        $search = array('kode_unit', 'unit_kerja');
        $where  = null; 
    ...
    public function modal(){
        ...
        $kode_ = $this->input->post('kode_unit');
        $data['kode_unit'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_unit_kerja',$data,TRUE);
        echo $html_modal;
    }
