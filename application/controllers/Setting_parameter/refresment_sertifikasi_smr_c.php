...
class refresment_sertifikasi_smr_c extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->view('Setting_parameter/refresment_sertifikasi_smr_v',$data);
        $this->load->view('Templates/Footer_v');
    } 

    public function get(){
        $query = 	"SELECT * FROM refresment_sertifikasi_smr";
        $search = array('level_sertifikasi_smr', 'masa_tenggang_sertifikasi');
        $where  = null; 
    ...
    public function modal(){
        $table = 'refresment_sertifikasi_smr';
        $field = 'level_sertifikasi_smr';
        $modal = $this->input->post('modal');
        $id = $this->input->post('id');
        $kode_ = $this->input->post('level_sertifikasi_smr');
        $data['level_sertifikasi_smr'] = $this->training_parameter->where($kode_,$table,$field)->row();
        $data['modal_title'] = $modal;
        $data['id'] = $id;
        $html_modal = $this->load->view('Modal/Modal_sertifikasi_smr',$data,TRUE);
        echo $html_modal;
    }
